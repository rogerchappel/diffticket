...
Replace this section with the supported versions for `diffticket`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `diffticket` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in diffticket.
